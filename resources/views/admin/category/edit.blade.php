            ...
            <div class="card-body">
                <form action="{{ route('admin.category.update', $category->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" id="text-input" name="name" value="{{ $category->name }}" placeholder="Text" class="form-control @error('name') is-invalid @enderror">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            @if (file_exists($category->thumbnail))
                                <img src="{{ asset($category->thumbnail) }}" height="50" class="mb-2">
                            @endif
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <label class="mr-3"><input type="radio" name="status" value="1" {{ $category->status ? 'checked' : '' }}> Active</label>
                            <label><input type="radio" name="status" value="0" {{ $category->status == 0 ? 'checked' : '' }}> Inactive</label>
