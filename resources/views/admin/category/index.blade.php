    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('admin.category.create') }}" class="btn btn-primary btn-sm float-right">Add New</a>
            </div>
            <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                @if (file_exists($category->thumbnail))
                                    <img src="{{ asset($category->thumbnail) }}" height="50" alt="">
                                @else
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <form action="{{ route('admin.category.destroy', $category->id) }}" method="post" class="delete_form">
                                        @csrf
                                        @method('DELETE')
